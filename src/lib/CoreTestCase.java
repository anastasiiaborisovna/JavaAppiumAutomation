...
public class CoreTestCase extends TestCase {
    ...
    protected void rotateScreenLandscape() { this.driver.rotate(ScreenOrientation.LANDSCAPE); }
    ...
    private AppiumDriver getDriver() throws Exception {
        ...
        if (System.getenv("PLATFORM").equals(platformAndroid)) {
            return new AndroidDriver(URL, this.getCapabilitiesByPlatformEnv());
        } else if (System.getenv("PLATFORM").equals(platformIos)) {
